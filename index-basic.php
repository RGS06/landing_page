<?php
// Standalone front-end page rendering the SODE design without WordPress.
// Customize the institutions below as needed.

$institutions = [
  [ 'name' => 'Institution 1', 'tagline' => 'Excellence in education and values.', 'url' => 'https://example.com/institution-1' ],
  [ 'name' => 'Institution 2', 'tagline' => 'Innovative programs for future leaders.', 'url' => 'https://example.com/institution-2' ],
  [ 'name' => 'Institution 3', 'tagline' => 'Holistic learning and research.', 'url' => 'https://example.com/institution-3' ],
  [ 'name' => 'Institution 4', 'tagline' => 'Building character and careers.', 'url' => 'https://example.com/institution-4' ],
  [ 'name' => 'Institution 5', 'tagline' => 'Tradition with modern excellence.', 'url' => 'https://example.com/institution-5' ],
  [ 'name' => 'Institution 6', 'tagline' => 'Nurturing minds for tomorrow.', 'url' => 'https://example.com/institution-6' ],
  [ 'name' => 'Institution 7', 'tagline' => 'Committed to quality education.', 'url' => 'https://example.com/institution-7' ],
];
  ...
  <main id="primary" class="site-main sode-landing">
    <div class="sode-wrap">
      ...
      <section class="sode-grid" aria-label="Institutions">
        ...
        ?>
          <a class="sode-card" href="<?php echo h($url); ?>" aria-label="<?php echo $name; ?>: <?php echo $tagline; ?>">
